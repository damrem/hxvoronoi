...
class Edge {
	...
	public function makeDelaunayLineBmp():BitmapData
	{
		...
		lineSprite.graphics.lineStyle(0, 0, 1.0, false, LineScaleMode.NONE, CapsStyle.NONE);
		lineSprite.graphics.moveTo(p0.x, p0.y);
		lineSprite.graphics.lineTo(p1.x, p1.y);
	...
	public var clippedEnds(default, null):Map<String, Point>;
	...
	public function clipVertices(bounds:Rectangle):Void
	{
		...
		clippedEnds = new Map<String, Point>();
